  ...
  return (
    <SiteFrame>
      <section className="gg-hero">
        <img src="/field-01.jpg" alt="동성건설 토목 기반 공사 현장" />
        ...
        <div className="gg-projects__rail">
          {projects.map((project, index) => (
            <Link href="/gallery" className="gg-project-card" key={project.title}>
              <figure><img src={project.image} alt={`${project.title} 현장`} /></figure>
      ...
      <section className="gg-business">
        ...
        <div className="gg-business__grid">
          <Link href="/services/scope" className="gg-business-card gg-business-card--civil"><HardHat size={35} /><span>01</span><h3>토목</h3><p>대한민국의 생활과 도시의 흐름을<br />더 안전하고 풍요롭게</p><strong>CIVIL WORKS</strong><b>자세히 보기 <ArrowRight size={17} /></b></Link>
          <Link href="/services/scope" className="gg-business-card gg-business-card--architecture"><Building2 size={35} /><span>02</span><h3>건축</h3><p>사람이 머무는 공간을<br />더 편리하고 쾌적하게</p><strong>ARCHITECTURAL WORKS</strong><b>자세히 보기 <ArrowRight size={17} /></b></Link>
          <Link href="/services/scope" className="gg-business-card gg-business-card--plant"><Factory size={35} /><span>03</span><h3>외부 시설</h3><p>도로와 건축을 연결하는 환경을<br />더 정교하고 오래도록</p><strong>FIELD WORKS</strong><b>자세히 보기 <ArrowRight size={17} /></b></Link>
        </div>
      </section>
